<template>
  <div class="products-page">
    ...
    <section class="hero-section">
      <div class="hero-bg">
        <span class="hero-label">{{ $t('bestSellers.topRated') }}</span>
        <h1 class="hero-title">{{ $t('bestSellers.bestSellers') }}</h1>
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          <div class="search-wrapper">
            ...
            <input
              ...
              type="text"
              :placeholder="$t('search.placeholderBestSellers')"
              class="search-input"
            />
          </div>
        </div>
        <div class="toolbar-right">
          ...
          <select
            ...
            class="sort-select"
          >
            <option value="rating">{{ $t('products.sortTopRatedLabel') }}</option>
      ...
      <div class="layout">
        ...
        <div class="main-content">
          ...
          <div v-else-if="error" class="state-card">
            ...
            <p class="state-text">{{ $t('bestSellers.errorLoading') }}</p>
          ...
          <div v-else-if="!products.length" class="state-card">
            ...
            <p class="state-text">{{ $t('bestSellers.emptyFilters') }}</p>
