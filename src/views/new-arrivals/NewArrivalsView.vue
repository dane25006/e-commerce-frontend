<template>
  <div class="products-page">
    ...
    <section class="hero-section">
      <div class="hero-bg">
        <span class="hero-label">Fresh Drops</span>
        <h1 class="hero-title">New Arrivals</h1>
        <p v-if="meta" class="hero-count">{{ meta.total }} new scent{{ meta.total !== 1 ? 's' : '' }}</p>
      </div>
    </section>
      ...
      <div class="layout">
        ...
        <div class="main-content">
          ...
          <div v-else-if="error" class="state-card">
            ...
            <p class="state-text">Something went wrong while loading new arrivals. Please try again.</p>
          ...
          <div v-else-if="!products.length" class="state-card">
            ...
            <p class="state-text">No new arrivals match your current filters. Try adjusting them to discover the latest drops.</p>
